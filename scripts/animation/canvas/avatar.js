...
class Avatar extends IAvatar {
    constructor() {
        ...
        draw(context, parent) {
            ...
            if (typeof this.args.strokeColor !== constants.types.UNDEFINED && this.args.strokeColor) {
            ...
            switch(this.type) {
                ...
                case type.color:
                    ...
                    break;
                case type.image:
                    if (typeof this.args.img === constants.types.UNDEFINED || !this.args.img)
                        break;
                    if (typeof this.args.imgX === constants.types.UNDEFINED || !this.args.imgX)
                        this.args.imgX = 0;
                    if (typeof this.args.imgY === constants.types.UNDEFINED || !this.args.imgY)
                        this.args.imgY = 0;
                    if (typeof this.args.imgWidth === constants.types.UNDEFINED || !this.args.imgWidth)
                        this.args.imgWidth = this.args.img.width;
                    if (typeof this.args.imgHeight === constants.types.UNDEFINED || !this.args.imgHeight)
                        this.args.imgHeight = this.args.img.height;
                    if (typeof this.args.destX === constants.types.UNDEFINED || !this.args.destX)
                        this.args.destX = 0;
                    if (typeof this.args.destY === constants.types.UNDEFINED || !this.args.destY)
                        this.args.destY = 0;
                    if (typeof this.args.destWidth === constants.types.UNDEFINED || !this.args.destWidth)
                        this.args.destWidth = this.args.imgWidth;
                    if (typeof this.args.destHeight === constants.types.UNDEFINED || !this.args.destHeight)
